...
function App() {
  ...
  const bookData = [
    ...
    { id: 2, name: 'flutter', author: 'Author 2', catégorie: 'mobile'},
    { id: 2, name: 'angular', author: 'Author 3', catégorie: 'web'}
  ]
  ...
  const editBook = book => {
    setEdit(true)
    setCurrentBook({ id:book.id, name:book.name, author:book.author, catégorie:book.categorie })
  }
  // UPDATE A BOOK
